(function() {
    ...
    var db = {
        ...
        loadData: function(filter) {
            return $.grep(this.guidelines, function(guideline) {
                return (!filter.Name || guideline.Name.indexOf(filter.Name) > -1)
        ...
        insertItem: function(insertingGuideline) {
            this.guidelines.push(insertingGuideline);
        },
	...
	$.get("../../php/action_page.php", function (data) {
		...
		for (el in list) {
		/*
			$('.guidelines').append('<div class="oneguideline"><div class="guidelineTitle"></div><div class="guidelineDescription"></div><div class="guidelineReference"></div><div class="guidelineCat"></div><div class="guidelineSubCat"></div><div class="guidelineBadges"><div class="guidelineBadge"></div></div></div>');
			$(".guidelineTitle:last").text(list[el]["TITLE"]);
			$(".guidelineDescription:last").text(list[el]["DESCRIPTION"]);
			$(".guidelineReference:last").text(list[el]["REFERENCE"]);
